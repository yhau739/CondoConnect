...
class UpcomingBookingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_upcoming_bookings, container, false)
        ...
        recyclerView = view.findViewById(R.id.recyclerViewUpcomingBookings)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (facilitySnapshot in snapshot.children) {
                    ...
                    for (bookingSnapshot in bookingsSnapshot.children) {
                        ...
                        if (booking != null && booking.uid == currentUserId && isFutureDate(booking.bookingDate, currentDate)) {
